...
```bash
export LONGLIVE_VBENCH_DATA_PATH=/mnt/share/r50063443/LongLive/vbench/videos
export LONGLIVE_VBENCH_FULL_INFO=/mnt/share/r50063443/LongLive/vbench/VBench_full_info.json
